<div class="mt-6">
  ...
  <input type="{{ $attributes['type'] }}" id="{{ $attributes['name'] }}" name="{{ $attributes['name'] }}" class="block w-full rounded-md border-0 @error($attributes['name']) animate-shake ring-red-600 ring-2 @enderror py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-800 sm:text-sm sm:leading-6" value="{{ old($attributes['name']) }}">
